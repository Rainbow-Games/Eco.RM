...
[LocDescription("Supplies battery power to an object.")]
[HasIcon("BatterySupplyComponentIcon")]
[CreateComponentTabLoc("Battery Supply")]
public partial class BatterySupplyComponent : WorldObjectComponent, INotifyPropertyChanged
{
    ...
    [Serialized, Autogen, UITypeName("PropertyPage"), SyncToView, Notify] public EnergyPool Pool { get; private set; } = new EnergyPool();
